...
<?php
	...
	while($pila=mysqli_fetch_array($seeall)){
		...
		$post = mysqli_query($con, "SELECT * FROM members WHERE member_id='$fromhum'")or die(mysql_error());
		...
		echo '
			...
			<div  class="rightrigh">
			<ul id="sddm">
			<li><a class="abc" href="acceptoffres.php?id='.$row['member_id'].'" rel="facebox" >Accept Friend Request</a></li><li>l</li><li><a class="abc" href="profile.php">Ignore for now</a></li>
			</div></ul>
