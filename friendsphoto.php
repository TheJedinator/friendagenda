...
$member_id = $_SESSION['SESS_MEMBER_ID'];
					$post = mysqli_query($con, "SELECT * FROM members WHERE member_id = '$userid'")or die(mysql_error());
...
$result = mysqli_query($con, "SELECT * FROM photos WHERE member_id='$userid'");
...
<?php
$member_id = $_SESSION['SESS_MEMBER_ID'];
$result = mysqli_query($con, "SELECT * FROM photos WHERE member_id='$userid'  ORDER BY photo_id DESC");
