...
//If there are input validations, redirect back to the registration form
	...
	//Create INSERT query
	$qry = "INSERT INTO members(UserName, Password, FirstName, LastName, Address, ContactNo, email, Birthdate, Gender, profImage, curcity, month, day, year) VALUES('$login','$password','$fname','$lname','$address','$cnumber','$email','$bday','$gender','$propic','$address','$month','$day','$year')";
	$result = @mysqli_query($con, $qry);
