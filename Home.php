...
$strQuery = "SELECT * FROM members WHERE member_id='$id'";
$image=mysqli_query($con, $strQuery);
...
<?php
$strMemberQuery = "SELECT * FROM members WHERE member_id='".$_SESSION['SESS_MEMBER_ID'] ."'";
$result = mysqli_query($con, $strMemberQuery);
...
while($row = mysqli_fetch_assoc($result))
{
   echo '<div class="information">';
	echo '<div class="pic1">';
	$strQuery = "SELECT * FROM members WHERE member_id='".$_SESSION['SESS_MEMBER_ID'] ."'";
